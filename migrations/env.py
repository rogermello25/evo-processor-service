...
def normalize_asyncpg_db_url(db_url: str) -> str:
    """Normalize Postgres URL params for asyncpg/Alembic compatibility."""
    ...
    for source, target in replacements.items():
        async_db_url = async_db_url.replace(source, target)

    return async_db_url.rstrip("?&")
...
def run_migrations_online() -> None:
    ...
    if connectable is None:
        ...
        async_db_url = normalize_asyncpg_db_url(db_url)
